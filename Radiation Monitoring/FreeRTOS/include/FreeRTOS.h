...
/* The timers module relies on xTaskGetSchedulerState(). */
	...
	#define portSET_INTERRUPT_MASK_FROM_ISR() 1
#endif
...
void vLowStatusTask (void *pvParameters);
void vMediumStatusTask (void *pvParameters);
void vHighStatusTask (void *pvParameters);
